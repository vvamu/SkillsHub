...
public class LessonService : AbstractLogModelService<Lesson>, ILessonService
{
    ...
    protected override DbSet<Lesson> _contextModel => _context.Lessons;

    protected override FluentValidation.IValidator<Lesson> _validator => new LessonValidator();
    protected override IQueryable<Lesson>? _fullInclude => _context.Lessons
    ...
    public LessonService(ApplicationDbContext context, IUserService userService, UserManager<ApplicationUser> userManager, INotificationService notificationService) : base(context)
    {
    ...
    public async Task<Lesson> GetAsync(Guid? itemId, bool withParents = false)
    {
        var id = (Guid)itemId;
    ...
    public async Task DeleteLessonByGroup(SkillsHub.Domain.Models.Group group, Lesson lesson)
    {
    ...
    public async Task<List<Lesson>> CreateLessonsBySchedule(SkillsHub.Domain.Models.Group group, int countLessons, bool isVerified = true, bool IsLessonCreatedWithNotifications = true)
    {
    ...
    */
    ...
    public async Task<SkillsHub.Domain.Models.Group> GetGroupAsync(Guid id)
    {
