...
//        IMapper mapper, IAbstractLogModelService<BaseUserInfo> baseUserInfoService, IUserService userService)
//    {
//        _context = context;
...
//    //    userDb = await _userService.CreateAsync(user);
...
//    //{
//    //    if (_context.Users.Find(model.ApplicationUserId) == null || _context.BaseUserInfo.Find(model.BaseUserInfoId) == null) throw new Exception("User is not found");
...
//    //{
//    //    if (_context.Users.Find(userId) == null || _context.BaseUserInfo.Find(baseUserInfoId) == null) throw new Exception("User is not found");
...
//        if (user != null)
//        {
//            userDb = await _userService.UpdateAsync(user);
