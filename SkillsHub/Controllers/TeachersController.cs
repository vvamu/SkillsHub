...
//            ApplicationUser user = await _userService.GetById(item.ApplicationUserId);//= student.ApplicationUser  ?? new ;
...
//            //user = await _userService.GetById(item.ApplicationUserId);
...
//        try
//        {
//            var user = await _context.Users.FindAsync(id) ?? await _userService.GetCurrentUserAsync();
...
//        ApplicationUser user = await _context.Users.FindAsync(item.ApplicationUserId);
//        try
//        {
//            if (teacher == null)
//            {
